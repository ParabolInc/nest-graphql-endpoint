...
const pruneLocalTypes = (doc, prefix, info) => {
    ...
    const rootType = (0, graphql_1.getNamedType)(returnType);
    if (rootType.name.startsWith(prefix) || (0, graphql_1.isLeafType)(rootType))
        return doc;
    ...
    const fragmentVisitor = (node) => {
        ...
        if (!(0, graphql_1.isAbstractType)(valueType))
            return null;
    ...
    const fixedDoc = (0, graphql_1.visit)(doc, {
...
//# sourceMappingURL=pruneInterfaces.js.map